...
public abstract class GroupAdapter<T> {
    ...
    /**
     * Creates a dungeon group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the external group.
     *
     * @param eGroup the external group
     * @return a dungeon group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the external group
     */
    public abstract DungeonGroup createDungeonGroup(T eGroup);

    /**
     * Creates an external group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the dungeon
     * group.
     *
     * @param dGroup the dungeon group
     * @return an external group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the dungeon group
     */
    public abstract T createExternalGroup(DungeonGroup dGroup);

    /**
     * Returns the dungeon group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the external
     * group or null of none exists.
     *
     * @param eGroup the external group
     * @return the dungeon group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the external
     *         group
     */
    public abstract DungeonGroup getDungeonGroup(T eGroup);

    /**
     * Returns the external group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the dungeon
     * group.
     *
     * @param dGroup the dungeon group
     * @return the external group {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} with the dungeon
     *         group
     */
    public abstract T getExternalGroup(DungeonGroup dGroup);
     ...
     */
    public DungeonGroup getOrCreateDungeonGroup(T eGroup) {
        DungeonGroup dGroup = getDungeonGroup(eGroup);
        if (dGroup == null) {
     ...
     */
    public T getOrCreateExternalGroup(DungeonGroup dGroup) {
     ...
     */
    public abstract boolean areCorresponding(DungeonGroup dGroup, T eGroup);

    /**
     * Ensures that the player is in {@link #areCorresponding(de.erethon.dungeonsxl.api.player.DungeonGroup, java.lang.Object) corresponding} groups.
     * <p>
     ...
     * {@link de.erethon.dungeonsxl.api.player.DungeonGroup.Philosophy.RUNTIME} or {@link de.erethon.dungeonsxl.api.player.DungeonGroup.Philosophy.ONLINE}.
     *
